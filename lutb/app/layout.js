          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            {produtosOpen && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', padding: '0 5px' }}>
                <button onClick={() => setColecoesOpen(!colecoesOpen)} style={{ backgroundColor: 'white', color: 'black', padding: '8px 20px', borderRadius: '20px', border: 'none', fontWeight: 'bold' }}>Coleções</button>
                {colecoesOpen && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', alignItems: 'center' }}>
                    <Link href="/colecao-verao" onClick={closeMenu} style={{ color: 'white', textDecoration: 'none', fontSize: '14px' }}>Coleção Verão</Link>
                    <Link href="/colecao-pascoa" onClick={closeMenu} style={{ color: 'white', textDecoration: 'none', fontSize: '14px' }}>Coleção Páscoa</Link>
                ...
                <button onClick={() => setCategoriasOpen(!categoriasOpen)} style={{ backgroundColor: 'white', color: 'black', padding: '8px 20px', borderRadius: '20px', border: 'none', fontWeight: 'bold' }}>Categorias</button>
                {categoriasOpen && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', alignItems: 'center' }}>
                    <Link href="/roupas" onClick={closeMenu} style={{ color: 'white', textDecoration: 'none', fontSize: '14px' }}>Roupas</Link>
                    <Link href="/acessorios" onClick={closeMenu} style={{ color: 'white', textDecoration: 'none', fontSize: '14px' }}>Acessórios</Link>
