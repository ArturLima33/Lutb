...
export default function RootLayout({ children }) {
  ...
  const [colecoesDinamicas, setColecoesDinamicas] = useState([]);
  ...
  useEffect(() => {
    ...
    setCategoriasDinamicas(categoriasSalvas);
    setColecoesDinamicas(colecoesSalvas);
  }, []);
              ...
              <div style={{
                ...
                {colecoesOpen && (
                  <div style={{
                    ...
                    {colecoesDinamicas.map((c, index) => (
                      <Link
                        key={index}
                        href={`/colecao/${c.nome.toLowerCase()}`}
                        onClick={closeMenu}
                        style={{
                          color: 'white',
                          textDecoration: 'none',
                ...
                {categoriasOpen && (
                  <div style={{
                    ...
                    {categoriasDinamicas.map((c, index) => (
                      <Link
                        key={index}
                        href={`/categoria/${c.nome.toLowerCase()}`}
                        onClick={closeMenu}
                        style={{
                          color: 'white',
                          textDecoration: 'none',
